...
PICS = (environ.get('PICS', ' https://telegra.ph/file/dfcdd75938ac710d9ead4.jpg https://telegra.ph/file/9836ce7b587a078f7db13.jpg https://telegra.ph/file/06068fb6049b0d9eca313.jpg https://telegra.ph/file/fa693d5e5086be1c3ddff.jpg https://telegra.ph/file/d8ecf7ce09b7dd322dd20.jpg https://telegra.ph/file/e84480d51f713e5f7e95f.jpghttps://telegra.ph/file/d24dbb92e0180f1fd7440.jpg https://telegra.ph/file/ab30e12110c73994cde6e.jpg ')).split()
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Zen_network')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "False")), False)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "False")), False)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [Zen Network](https://t.me/zen_network)</b>⚡\n\n🎦 <b>File Name: </b> ➥  <i>{file_caption}</i>\n⚙️ <b>Size: </b><i>{file_size}</i>")
BATCH_FILE_CAPTION = environ.get("BATCH_FILE_CAPTION", CUSTOM_FILE_CAPTION)
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>Your Query: {query}</b> \n‌‌‌‌IMDb Data  \n\n🏷 Title: <a href={url}>{title}</a>\n🎭 Genres: {genres}\n📆 Year: <a href={url}/releaseinfo>{year}</a>\n🌟 Rating: <a href={url}/ratings>{rating}</a> / 10 ⚠️Click on the button 👇 below to get your query privately")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','tpx_bots') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','Channel_UserName') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','zen_network') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','techburner')  # WITHOUT @ [  add only handle - don't add full url  ] 
...
DOWNLOAD_TEXT_URL = "https://t.me/zen_network"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Zen_network"
